...
class topUp extends StatefulWidget {
  ...
  @override
  State<topUp> createState() => _topUpPageState();
}

class _topUpPageState extends State<topUp> {
              ...
              children: [
                    ...
                    children: [
                      ...
                      const Text("Deposit to",
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                              color: Colors.white70)), // deposit to
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('Deposit Money',style: TextStyle(fontSize: 20,color: Color(0xFFE9C1F6)),),
                  ),), // submit button
                SizedBox(height: 170),
                Image.asset(
